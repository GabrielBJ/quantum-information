...
Although this work is focused on two financial applications, the quantum algorithms reviewed here can be applied to a wide range of financial problems. In recent years, important surveys have been published on the topic of quantum computing in finance \cite{Orus2019,Egger2020a,Albareti2022,Herman2022,Herman2023} 
and we refer the interested readers to these works for a more comprehensive overview of the field.
